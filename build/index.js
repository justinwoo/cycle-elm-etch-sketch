...
/***/ function(module, exports) {
	...
	Elm.Board.make = function (_elm) {
	   ...
	   function (v) {
	      return typeof v === "object" && "points" in v && "cursor" in v ? {_: {}
	                                                                       ...
	                                                                       ,cursor: typeof v.cursor === "object" && v.cursor instanceof Array ? {ctor: "_Tuple2"
	                                                                                                                                            ,_0: typeof v.cursor[0] === "number" ? v.cursor[0] : _U.badPort("a number",
	                                                                                                                                            v.cursor[0])
	                                                                                                                                            ,_1: typeof v.cursor[1] === "number" ? v.cursor[1] : _U.badPort("a number",
	   ...
	   var cellSize = 16;
	   var drawPoint = F2(function (color,
	   coords) {
	      return function () {
	         var $ = coords,
	         x = $._0,
	         ...
	         return $Graphics$Collage.move({ctor: "_Tuple2"
	                                       ...
	                                       ,_1: $Basics.toFloat(y) * cellSize})($Graphics$Collage.filled(color)(A2($Graphics$Collage.rect,
	         cellSize,
	         cellSize)));
	      }();
	   });
	   ...
	   model) {
	      return function () {
	         ...
	         {case "_Tuple2":
	            return function () {
	                 var cursor = A2(drawPoint,
	                 A3($Color.rgb,0,0,0),
	                 model.cursor);
	                 var points = A2($List.map,
	                 drawPoint(A3($Color.rgb,
	                 50,
	                 50,
	                 50)),
	                 model.points);
