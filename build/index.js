...
/***/ function(module, exports, __webpack_require__) {
	...
	var _boardDriver = __webpack_require__(/*! ./board-driver */ 6);
	
	var _boardDriver2 = _interopRequireDefault(_boardDriver);
	
	var _keyboardDriver = __webpack_require__(/*! ./keyboard-driver */ 8);
	
	var _keyboardDriver2 = _interopRequireDefault(_keyboardDriver);
	
	function deduplicatePoints(points) {
	  var newPoints = [];
	  var pointsObject = points.reduce(function (aggregate, point) {
	...
	var drivers = {
	  keyboard: (0, _keyboardDriver2['default'])(),
	  board: (0, _boardDriver2['default'])()
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = makeBoardDriver;
...
/***/ function(module, exports) {
	...
	Elm.Board.make = function (_elm) {
	   ...
	   var _op = {};
	   var model = Elm.Native.Port.make(_elm).inboundSignal("model",
	   "Board.Model",
	   function (v) {
	      return typeof v === "object" && "points" in v && "cursor" in v ? {_: {}
	                                                                       ...
	                                                                       ,cursor: typeof v.cursor === "object" && v.cursor instanceof Array ? {ctor: "_Tuple2"
	                                                                                                                                            ,_0: typeof v.cursor[0] === "number" && isFinite(v.cursor[0]) && Math.floor(v.cursor[0]) === v.cursor[0] ? v.cursor[0] : _U.badPort("an integer",
	                                                                                                                                            v.cursor[0])
	                                                                                                                                            ,_1: typeof v.cursor[1] === "number" && isFinite(v.cursor[1]) && Math.floor(v.cursor[1]) === v.cursor[1] ? v.cursor[1] : _U.badPort("an integer",
	                                                                                                                                            v.cursor[1])} : _U.badPort("an array",
	   ...
	   var Model = F2(function (a,b) {
	      return {points: a,cursor: b};
	   });
	   var cellSize = 16;
	   var drawPoint = F2(function (color,coords) {
	      var _p0 = coords;
	      var x = _p0._0;
	      var y = _p0._1;
	      return A2($Graphics$Collage.move,
	      {ctor: "_Tuple2"
	      ,_0: $Basics.toFloat(x) * cellSize
	      ,_1: $Basics.toFloat(y) * cellSize},
	      A2($Graphics$Collage.filled,
	      color,
	      A2($Graphics$Collage.rect,cellSize,cellSize)));
	   });
	   var view = F2(function (_p1,model) {
	      var _p2 = _p1;
	      var cursor = A2(drawPoint,A3($Color.rgb,0,0,0),model.cursor);
	      var points = A2($List.map,
	      drawPoint(A3($Color.rgb,50,50,50)),
	      model.points);
	      return A3($Graphics$Collage.collage,
	      _p2._0,
	      _p2._1,
	      A2($List.append,points,_U.list([cursor])));
	   });
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = makeKeyboardDriver;
	...
	exports.RIGHT = RIGHT;
	var UP_INPUTS = [38, 75];
	var DOWN_INPUTS = [40, 74];
	var LEFT_INPUTS = [37, 72];
	var RIGHT_INPUTS = [39, 76];
	
	var MAPPINGS = [[UP_INPUTS, UP], [DOWN_INPUTS, DOWN], [LEFT_INPUTS, LEFT], [RIGHT_INPUTS, RIGHT]];
	  ...
	  return function keyboardDriver() {
	    var directionInput$ = _rx2['default'].Observable.fromEvent(window, 'keydown').map(function (_ref) {
	      ...
	      for (var i = 0; i < MAPPINGS.length; i++) {
	        var _MAPPINGS$i = _slicedToArray(MAPPINGS[i], 2);
	
	        var inputs = _MAPPINGS$i[0];
	        var direction = _MAPPINGS$i[1];
